...
function analognxt_setup() {
	/*
		...
		* If you're building a theme based on AnalogNXT, use a find and replace
		* to change 'analognxt' to the name of your theme in all the template files.
		*/
 ...
 */
function analognxt_scripts() {
	wp_enqueue_style( 'analognxt-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'analognxt-style', 'rtl', 'replace' );

	wp_enqueue_script( 'analognxt-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
